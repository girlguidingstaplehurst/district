...
The system SHALL load published `districtNavigation` entries and use their labels, destinations, parent relationships, and ordering to construct the site navigation tree.
